...
(function () {
  ...
  function PostsController($scope) {
    ...
    /**
     * @name activate
     * @desc Actions to be performed when this controller is instnatiated
     ...
     * @returns The inex of the shortest column
     * @memberOf thinkster.posts.controllers.PostsController
     */
     ...
     * @params {Number} m The first number
     * @params {Number} n the second number
     * @returns The sum
     */
    function sum(m,n) {
      return m + n;
