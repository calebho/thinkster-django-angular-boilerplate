...
(function () {
  ...
  function ProfileSettingsController($location, $routeParams, Authentication, Profile, Snackbar) {
     ...
     * @memeberOf thinkster.profiles.controller.ProfileSettingsController
     */
    function activate() {
      ...
      if (!authenticatedAccount) {
        ...
        //Redirected if logged in, but not the owner of this profile
    ...
    function update() {
       ...
       */
      function profileSuccessFn(data, status, headers, config) {
        Snackbar.show('You profile has been updated');
      }
